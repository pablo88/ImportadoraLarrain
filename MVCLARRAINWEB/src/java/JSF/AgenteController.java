...
import SessionBeans.AgenteFacade;
...
public class AgenteController implements Serializable {
    ...
    @EJB
    private SessionBeans.AgenteFacade ejbFacade;
    ...
    public Agente getAgente(java.math.BigDecimal id) {
    ...
    public static class AgenteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Agente) {
                ...
                return getStringKey(o.getIdAgente());
            } else {
