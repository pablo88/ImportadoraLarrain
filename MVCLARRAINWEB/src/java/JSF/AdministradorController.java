...
import SessionBeans.AdministradorFacade;
...
public class AdministradorController implements Serializable {
    ...
    @EJB
    private SessionBeans.AdministradorFacade ejbFacade;
    ...
    public Administrador getAdministrador(java.math.BigDecimal id) {
